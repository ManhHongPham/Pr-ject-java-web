			...
			<div class="row">
				...
				<div class="col-lg-7 col-md-7 col-sm-12">
					<div class="p-d-wrapper">
						...
						<span class="p-d-price">price: <fmt:setLocale value="vi_VN"
								scope="session" /> <fmt:formatNumber value="${product.price }"
								type="currency" />
						</span> <span class="p-d-price">price sale: <fmt:setLocale
								value="vi_VN" scope="session" /> <fmt:formatNumber
								value="${product.price_sale }" type="currency" />
						</span> <span class="model-stock"> Category: <span> <span>${product.categories1.nameCategory }</span>
						</span>
						</span> 
						
						<div class="qty-cart-add">
							<label for="qty">qty</label> 
							<input type="number" placeholder="0" id="sl_${product.id }"> 
						...
						<div class="p-d-buttons">
							...
							<button type="button" 
						onclick="Cart.addItemToCart(${product.id }, 'sl_${product.id }')">Add to cart</button>
						</div>
				...
				<div class="p-tab-btn">
					<div class="nav" role="tablist">
						<a class="active" href="#tab1" data-toggle="tab" role="tab"
							aria-selected="true" aria-controls="tab1">Details</a> <a
							href="#tab2" data-toggle="tab" role="tab" aria-selected="false"
							aria-controls="tab2">Reviews 1</a>
					</div>
				</div>
	...
	<div class="related-products-area text-center">
		...
		<div class="container">
			<div class="custom-row">
				<div
					class="product-carousel owl-carousel carousel-style-one">
					<c:forEach items="${products }" var="p">

						<div class="custom-col">
							<div class="product-item">
								<div class="product-image-hover">
									<a href="${base }/product-details1/${p.getSeo()}"> 
									<img style="width: 250px; height: 250px;" class="primary-image"
