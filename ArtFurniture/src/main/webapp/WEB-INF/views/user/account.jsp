						...
						<div class="form-fields">
							...
							<p>
								<label for="reg-email" class="important">Username</label> <input
									type="text" id="reg-email" name="username">
							</p>

							<p>
								<label for="reg-email" class="important">Email address</label> <input
									type="text" id="reg-email" name="email">
							</p>
							<p>
								<label for="reg-email" class="important">Passwords</label> <input
									type="password" id="reg-email" name="password">
							</p>
							<p>
								<label for="reg-pass" class="important">Repassword</label> <input
									type="password" id="reg-pass" name="repassword">
							</p>
						</div>
