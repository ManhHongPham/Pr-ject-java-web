			...
			<div class="row">
				<div class="order-xl-2 order-lg-2 col-xl-9 col-lg-8">
					<div class="shop-banner">
						<img src="user/assets/img/banner/19.jpg" alt="">
					</div>
					...
					<div class="ht-product-tab">
						...
						<div class="shop-content-wrapper">
							<div class="shop-results">
								<span>Sort By</span> <select name="number" id="number">
							...
							<div class="shop-items">
								<a href="#"><i class="fa fa-long-arrow-up"></i></a> <span>Items
									1-12 of 14</span>
							</div>
						</div>
					</div>
										...
										<div class="product-item">
											<div class="product-image-hover">
												...
												<div class="product-hover">
													<span style="margin-right: -65px;">qty</span>
													
													<input type="number" placeholder="0" id="sl_${p.id }"
					...
					<div class="pagination-wrapper">
						...
						<div class="shop-results">
							<span>Show</span> <select name="number" id="b-number">
					...
					<div class="sidebar-widget widget-style-1 panel-group"
						...
						<div class="panel widget-option">
							<a class="collapsed" data-toggle="collapse" href="#manufacture"
								data-parent="#widget-parent">Manufacturer</a>
						...
						<div class="panel widget-option">
							<a class="collapsed" data-toggle="collapse" href="#price"
								data-parent="#widget-parent">Price</a>
